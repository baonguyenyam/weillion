...
function onContextMenu(e) {
  ...
  document.addEventListener('click', onMouseDown, false); // document.getElementById('text-replace').addEventListener('click', onMouseDown, false);
}

function onMouseDown(e) {
  hideMenu();
  document.removeEventListener('click', onMouseDown); // document.getElementById('text-replace').removeEventListener('click', onMouseDown);
}

document.addEventListener('contextmenu', onContextMenu, false); // document.getElementById('weiLionContextMenu').addEventListener('contextmenu', onContextMenu, false);
// APP
